...
<body>
	<div class="header">
		<div class="welcome">
			...
			<h4>MUNICIPALIDAD DE ILABAYA</h4>
			<h2 id="titulo">EQUIPOS INFORM&AacuteTICOS DE LA MDI </h2>
		</div>
		<div class="menu">
			<ul>
				<li><a href="{{action ('UserController@index')}}">Usuarios</a></li>
				<li>Oficina</li>
				<li class="menu">Equipos
					<!--<ul id="menu-detalles">
						<li>Impresora</li>
						<li>CPU</li>
						<li>Ploter</li>
	...
	<div class="footer">
		<h4>Unidad de Tecnologias de la Informacion y Comunicaciones</h4>
